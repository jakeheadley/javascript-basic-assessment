...
var firstHero = heroes.splice(0,1, 'superman').join();
// add 'spongebob' to the start of the array
//--------------------------------------------------------------------------------------------
// ^ Note: this is NOT clear: request relates to 'heroes', not firstHero. Not clear instruction ("gRRR").
heroes.unshift('spongebob');
//firstHero = firstHero.replace('superman', 'spongebob').split(); <- not correct, but by instruction is should be!
//--------------------------------------------------------------------------------------------
// remove 'flash' from the array and store him in a variable called secondHero
var sectondHero = heroes.splice(1,1, 'flash').join();
// leave batman in the array but put a copy of him on a variable called thirdHero
var thirdHero = heroes.splice(2,1, 'batman').join();
...
// It should double numbers, and repeats strings. example 4->8, 2.5->5, 'Awesome'->'AwesomeAwesome'
...
//It looks to see if the person’s name is Jeremy and then changes the person object to
//have a property called lovesCode with a value of 10.
...
// Almost correct - needs the complete string "grr" :(
